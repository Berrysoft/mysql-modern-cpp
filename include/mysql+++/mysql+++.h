...
#include <mysql+++/polyfill/datetime.h>
#include <mysql+++/polyfill/function_traits.h>

#include <optional>

namespace daotk::mysql
{
    using sqlite::utility::function_traits;
    using std::optional;
    ...
    namespace stmt_bind_detail
    {
        ...
        template <>
        struct my_bind<uint8_t> : my_number_bind<MYSQL_TYPE_TINY, uint8_t>
        {
        };
        template <>
        struct my_bind<int8_t> : my_number_bind<MYSQL_TYPE_TINY, int8_t>
        {
        };
        template <>
        struct my_bind<uint16_t> : my_number_bind<MYSQL_TYPE_SHORT, uint16_t>
        {
        };
        template <>
        struct my_bind<int16_t> : my_number_bind<MYSQL_TYPE_SHORT, int16_t>
        {
        };
        template <>
        struct my_bind<uint32_t> : my_number_bind<MYSQL_TYPE_LONG, uint32_t>
        {
        };
        template <>
        struct my_bind<int32_t> : my_number_bind<MYSQL_TYPE_LONG, int32_t>
        {
        };
        template <>
        struct my_bind<uint64_t> : my_number_bind<MYSQL_TYPE_LONGLONG, uint64_t>
        {
        };
        template <>
        struct my_bind<int64_t> : my_number_bind<MYSQL_TYPE_LONGLONG, int64_t>
        {
        };
        template <>
        struct my_bind<float> : my_number_bind<MYSQL_TYPE_FLOAT, float>
        {
        };
        template <>
        struct my_bind<double> : my_number_bind<MYSQL_TYPE_DOUBLE, double>
        {
        };

        template <>
        struct my_bind<bool> : my_number_bind<MYSQL_TYPE_TINY, bool>
        {
        };

        template <>
        struct my_bind<optional<uint8_t>> : my_optional_number_bind<MYSQL_TYPE_TINY, uint8_t>
        {
        };
        template <>
        struct my_bind<optional<int8_t>> : my_optional_number_bind<MYSQL_TYPE_TINY, int8_t>
        {
        };
        template <>
        struct my_bind<optional<uint16_t>> : my_optional_number_bind<MYSQL_TYPE_SHORT, uint16_t>
        {
        };
        template <>
        struct my_bind<optional<int16_t>> : my_optional_number_bind<MYSQL_TYPE_SHORT, int16_t>
        {
        };
        template <>
        struct my_bind<optional<uint32_t>> : my_optional_number_bind<MYSQL_TYPE_LONG, uint32_t>
        {
        };
        template <>
        struct my_bind<optional<int32_t>> : my_optional_number_bind<MYSQL_TYPE_LONG, int32_t>
        {
        };
        template <>
        struct my_bind<optional<uint64_t>> : my_optional_number_bind<MYSQL_TYPE_LONGLONG, uint64_t>
        {
        };
        template <>
        struct my_bind<optional<int64_t>> : my_optional_number_bind<MYSQL_TYPE_LONGLONG, int64_t>
        {
        };
        template <>
        struct my_bind<optional<float>> : my_optional_number_bind<MYSQL_TYPE_FLOAT, float>
        {
        };
        template <>
        struct my_bind<optional<double>> : my_optional_number_bind<MYSQL_TYPE_DOUBLE, double>
        {
        };

        template <>
        struct my_bind<optional<bool>> : my_optional_number_bind<MYSQL_TYPE_TINY, bool>
        {
        };
